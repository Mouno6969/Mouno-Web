    ...
    <main className="section">
      <div className="grid2">
        <section className="panel">
          ...
          <p className="lede">Paste your X profile URL or handle, the post URL, and optional post text. Posts containing #RefundYourSol or #RYS are easier to verify.</p>
          <p className="notice">Because there is no official X API key in this free first version, likes/comments/reposts are added by admin/manual sync before points are finalized.</p>
          <div className="grid3">
        ...
        <section className="panel">
          ...
          <form className="form" action={submitPromoterPost}>
            ...
            <label className="field">Pasted post text or evidence <textarea name="postText" placeholder="Include #RefundYourSol or #RYS when possible" /></label>
